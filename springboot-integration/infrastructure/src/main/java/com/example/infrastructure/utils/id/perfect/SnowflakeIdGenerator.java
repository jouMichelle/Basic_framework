...
import com.example.infrastructure.exception.BaseException;
...
public class SnowflakeIdGenerator {
    ...
    public synchronized long nextId() throws BaseException {
        long timestamp = System.currentTimeMillis();
        if (timestamp < lastTimestamp) {
            throw new BaseException("Clock moved backwards.  Refusing to generate id for " + (
     ...
     */
    protected long getWorkerId() throws BaseException {
        try {
